      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="mt-3 flex items-center gap-2">
            <Button
              onClick={onConnectAndIngest}
              disabled={!currentConn || isConnecting || isIngesting}
            >
          ...
          <p className="text-[12px] text-[var(--text-secondary)] mt-2">
            If you change the connection string later, run ingestion again to repopulate the
            database.
          </p>
        </div>
      </div>
