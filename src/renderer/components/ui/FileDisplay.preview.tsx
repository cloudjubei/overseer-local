...
export default function Preview() {
  ...
  return (
    <div style={{ display: 'grid', gap: 12, padding: 16, background: 'var(--surface-0, #fafafa)' }}>
      ...
      <FileDisplay file={{ ...sample, name: 'huge-video.mp4', type: 'video/mp4', size: 5_123_123_444 }} />
      <FileDisplay file={{ ...sample, name: 'package.json', type: 'application/json', size: 2541 }} density="compact" />
      <FileDisplay file={{ ...sample, name: 'README', type: 'text/plain', size: 112 }} trailing={<span className="badge">Pinned</span>} />
    </div>
  );
}
