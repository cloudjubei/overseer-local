...
import { ChatsProvider, useChatsContext } from 'src/renderer/contexts/ChatsContext';
import { useProjectSettings } from 'src/renderer/hooks/useProjectSettings';
...
const ChatView: React.FC<{ chatContextTitle: string; contextId: string }> = ({ chatContextTitle, contextId }) => {
  ...
  const { settings, setSettings } = useProjectSettings(projectId || '');
