...
const FeatureSummaryCallout: React.FC<FeatureSummaryProps> = ({ title, description, status, displayId }) => (
  <div className="summary-card p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md max-w-xs">
    <div className="text-xs text-gray-500 mb-1">Feature #{displayId}</div>
