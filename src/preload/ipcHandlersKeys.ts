const IPC_HANDLER_KEYS = {
  ...
  // Git monitor
  GIT_START_ALL: 'git:start-all',
  GIT_START_PROJECT: 'git:start-project',
  GIT_SUBSCRIBE: 'git:subscribe',

  GIT_GET_STATUS: 'git:get-status',
  GIT_TRIGGER_POLL: 'git:trigger-poll',
  GIT_SET_POLL_INTERVAL: 'git:set-poll-interval',
  GIT_HAS_UNMERGED: 'git:has-unmerged',
