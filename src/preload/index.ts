...
const GIT_API = {
  ...
  stagePaths: (projectId, paths) =>
    ipcRenderer.invoke(IPC_HANDLER_KEYS.GIT_STAGE_PATHS, { projectId, paths }),
  unstagePaths: (projectId, paths) =>
    ipcRenderer.invoke(IPC_HANDLER_KEYS.GIT_UNSTAGE_PATHS, { projectId, paths }),
  resetPaths: (projectId, paths) =>
    ipcRenderer.invoke(IPC_HANDLER_KEYS.GIT_RESET_PATHS, { projectId, paths }),
  removePaths: (projectId, paths) =>
    ipcRenderer.invoke(IPC_HANDLER_KEYS.GIT_REMOVE_PATHS, { projectId, paths }),
  commit: (projectId, input) => ipcRenderer.invoke(IPC_HANDLER_KEYS.GIT_COMMIT, { projectId, input }),
