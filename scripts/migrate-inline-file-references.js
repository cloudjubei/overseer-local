/*
  Migrate inline file references inside tasks/*/task.json to @Filepath tokens.
  Patterns handled:
  - `path/To/File.tsx` => @path/To/File.tsx
  - backticked filenames => @Filename.ext
  - bare filenames (e.g., TasksListView.tsx) within text => @TasksListView.tsx

  Run with: node scripts/migrate-inline-file-references.js
*/
