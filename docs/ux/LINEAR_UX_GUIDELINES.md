...
UX Checklists
- Task Create
  - [ ] Cmd/Ctrl+N opens quick create with Title focused
  - [ ] Minimal fields visible; advanced via keyboard or disclosure
  - [ ] Optimistic insert into current view with Undo toast
  - [ ] Esc cancels; Cmd/Ctrl+Enter creates
- Task Edit / Details Panel
  - [ ] Single-click or E to edit title
  - [ ] S/A/P/L/D open pickers with type-ahead
  - [ ] Comments submit with Cmd/Ctrl+Enter; supports mentions
  - [ ] Closing panel returns focus to originating item
- Status Changes
  - [ ] Drag-and-drop across board columns
  - [ ] S opens picker; bulk updates supported
  - [ ] Undo available where safe
- Command Menu
  - [ ] Cmd/Ctrl+K opens; search across tasks/projects/actions
  - [ ] Results navigable via keyboard; Enter executes
  - [ ] Action results navigate via Navigator consistently
- Accessibility
  - [ ] Focus rings visible and consistent
  - [ ] All interactive elements have accessible names
  - [ ] Dialogs and panels have correct roles and labels

Notes and References
- These guidelines are inspired by established patterns in Linear.app. Exact key bindings and UI details may vary; prioritize consistency, speed, and accessibility in our implementation.
